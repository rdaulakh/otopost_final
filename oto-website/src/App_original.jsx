  ...
  return (
    <div className="App">
      ...
      <nav className="futuristic-nav">
        <div className="nav-container">
          <div className="nav-logo">
            <img src={logo} alt="OTOPost" />
          </div>
          <div className="nav-links">
            <a href="#how-it-works" className="nav-link">How It Works</a>
            <a href="#ai-team" className="nav-link">AI Team</a>
            ...
            <div className="dashboard-container">
              ...
              <div className="dashboard-overlay">
                <div className="play-button">
                  ...
                  <span>See OTOPost in Action</span>
                </div>
              </div>
      ...
      <section className="problem-solution-section">
        <div className="container">
          <h2 className="section-title-consistent">
            Social media marketing is <span className="gradient-text-red">complex.</span><br />
      ...
      <section className="ai-team-section">
        <div className="container">
          <h2 className="section-title-consistent">
            This is Not Another <span className="gradient-text-red">"AI Assistant"</span>.<br />
          ...
          <div className="stat-item">
            ...
            <div className="stat-label">Always Active</div>
              ...
              <div className="team-description">
                ...
                <button className="btn-primary-large" onClick={() => window.location.hash = 'ai-team'}>
                    ...
                    <div className="demo-content">
                      <div className="demo-platforms">
                        <div className="platform-status">
                          <div className="platform-icon facebook-color">f</div>
                        ...
                        <div className="platform-status">
                          <div className="platform-icon instagram-color">ig</div>
                          <div className="platform-info">
                            <div>Instagram</div>
                            <div className="status-active">Active</div>
                          </div>
                        ...
                        <div className="platform-status">
                          <div className="platform-icon twitter-color">x</div>
                          <div className="platform-info">
                            <div>X (Twitter)</div>
                            <div className="status-active">Active</div>
                          </div>
      ...
      <section className="final-cta-section">
        <div className="container">
          <div className="cta-content">
            <h2 className="section-title-consistent">
              Ready to <span className="gradient-text-cyan">Revolutionize</span> Your Social Media?
            </h2>
        ...
        <div className="container">
          <div className="footer-main">
            <div className="footer-brand">
              <img src={logo} alt="OTOPost" className="footer-logo" />
              <p className="footer-description">
                Your autonomous AI marketing team for social media success. 
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-content">
              <p>&copy; 2024 OTOPost. All rights reserved.</p>

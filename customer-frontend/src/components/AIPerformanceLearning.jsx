...
const AIPerformanceLearning = ({ data, user, onDataUpdate }) => {
  ...
  // Use only real API data - no fallback static data

  // Use real API data for agent performance - no static arrays

  // All data now comes from real API - no static arrays

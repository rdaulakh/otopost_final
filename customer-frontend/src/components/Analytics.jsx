...
const Analytics = ({ data = {}, user = {}, onDataUpdate = () => {} }) => {
  ...
  const { data: overviewData, isLoading: isLoadingOverview, isError: isErrorOverview, refetch: refetchOverview } = useAnalyticsOverview(timeRange)
  const { data: audienceData, isLoading: isLoadingAudience, isError: isErrorAudience, refetch: refetchAudience } = useAnalyticsAudience({ timeRange, platform: selectedPlatform })
  const { data: contentData, isLoading: isLoadingContent, isError: isErrorContent, refetch: refetchContent } = useAnalyticsContent({ timeRange, platform: selectedPlatform })
  const { data: engagementData, isLoading: isLoadingEngagement, isError: isErrorEngagement, refetch: refetchEngagement } = useAnalyticsEngagement({ timeRange, platform: selectedPlatform })
  const { data: performanceData, isLoading: isLoadingPerformance, isError: isErrorPerformance, refetch: refetchPerformance } = useAnalyticsPerformance({ timeRange, platform: selectedPlatform })

  const isLoading = isLoadingOverview || isLoadingAudience || isLoadingContent || isLoadingEngagement || isLoadingPerformance
  const isError = isErrorOverview || isErrorAudience || isErrorContent || isErrorEngagement || isErrorPerformance

  const analyticsData = {
    overview: overviewData || {},
    platforms: performanceData?.platforms || {},
    topPosts: contentData?.topPosts || [],
    audience: audienceData || {},
    weeklyTrends: overviewData?.weeklyTrends || []
  }
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          {isLoading ? (
            <div className="text-center py-8">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">Loading overview data...</p>
            </div>
          ) : (
            <>
              {/* Key Metrics */}
                ...
                {[
                  {
                    ...
                    change: `+${analyticsData.overview.reachGrowth || 0}%`,
                    trend: 'up',
                    icon: Eye,
                    color: 'text-blue-600',
                  ...
                  },
                  {
                    ...
                    change: `+${analyticsData.overview.engagementGrowth || 0}%`,
                    trend: 'up',
                    icon: Heart,
                    color: 'text-pink-600',
                  ...
                  },
                  {
                    ...
                    change: `+${analyticsData.overview.followerGrowth || 0}%`,
                    trend: 'up',
                    icon: Users,
                  ...
                  },
                  {
                    ...
                    change: `+${analyticsData.overview.postsGrowth || 0} this month`,
                    trend: 'up',
                    icon: Calendar,
        ...
        <TabsContent value="platforms" className="space-y-6">
          {isLoading ? (
            <div className="text-center py-8">
              <RefreshCw className="h-8 w-8 animate-spin text-blue-500 mx-auto" />
              <p className="mt-2 text-slate-600 dark:text-slate-400">Loading platform data...</p>
            </div>
          ) : (
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Badge variant="secondary">{data.topPostType || 'N/A'}</Badge>
                          </div>
                          <div className="flex items-center justify-between">
        ...
        <TabsContent value="content" className="space-y-6">
          {isLoading ? (
            <div className="text-center py-8">
              <RefreshCw className="h-8 w-8 animate-spin text-blue-500 mx-auto" />
              <p className="mt-2 text-slate-600 dark:text-slate-400">Loading top content data...</p>
            </div>
          ) : (
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm dark:bg-slate-800/80">
              <CardHeader>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-6 text-sm">
                          ...
                          <div className="text-center">
                            <div className="font-medium text-slate-900 dark:text-slate-100">
                              {((post.engagement / (post.reach || 1)) * 100).toFixed(1)}%
                            </div>
        ...
        <TabsContent value="audience" className="space-y-6">
          {isLoading ? (
            <div className="text-center py-8">
              <RefreshCw className="h-8 w-8 animate-spin text-blue-500 mx-auto" />
              <p className="mt-2 text-slate-600 dark:text-slate-400">Loading audience data...</p>
            </div>
          ) : (

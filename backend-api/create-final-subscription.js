...
async function createFinalSubscription() {
  try {
    console.log('Creating final subscription...');
    ...
    // Create subscription with the correct enum values
    const subscriptionData = {
      organizationId: org._id,
      planId: 'basic',
      plan: 'basic', // Use the correct enum value
      planName: 'Basic Plan',
      status: 'active',
